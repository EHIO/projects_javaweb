...
function initUploadImage(showImg, type, button_id, file_size, path) {
    var swfuOption = {//swfupload选项
        upload_url: "/uploadImage/upload.action", //接收上传的服务端url
        flash_url: "/js/control/SWFUpload/Flash/swfupload.swf",//swfupload压缩包解压后swfupload.swf的url
        ...
        button_image_url: "/css/images/liulan_btn.png", //加上背景图片
